...
public class homework02_3 extends AppCompatActivity {
                ...
                cameraCaptureSession.capture(builder.build(), new CameraCaptureSession.CaptureCallback() {
                    ...
                    public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                        ...
                        try {
                            ...
                            Log.e(homework02_3.class.toString(), e.toString());
                        }
                    }
                }, null);
            } catch (Exception e) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateCallback = new CameraDevice.StateCallback() {
            ...
            public void onOpened(@NonNull CameraDevice cameraDevice) {
                ...
                homework02_3.this.cameraDevice = cameraDevice;
                //准备预览时使用的组件
                ...
                try {
                    ...
                    imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader imageReader) {
                            ...
                            buffer.get(bytes);
                            //写文件
                            File file = new File(Environment.getExternalStorageDirectory(), "abd.jpg");
                            FileOutputStream outputStream = null;
                            try {
                                outputStream = new FileOutputStream(file);
                                outputStream.write(bytes);
                                Toast.makeText(homework02_3.this, "save:" + file, Toast.LENGTH_LONG).show();
                            } catch (Exception e) {
                                Log.e(homework02_3.class.toString(), e.toString());
                            } finally {
                                try {
                                    ...
                                    Log.e(homework02_3.class.toString(), ee.toString());
                                }
                            }
                        }
                    }, null);
                    ...
                    cameraDevice.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            //开始显示相机的预览
                            homework02_3.this.cameraCaptureSession = cameraCaptureSession;
                            try {
            ...
            public void onDisconnected(@NonNull CameraDevice cameraDevice) {
                //摄像头关闭时，执行本方法。
                homework02_3.this.cameraDevice = null;
            }
    ...
    private void setCameraLayout() {
        //用户授权后，加载界面
        setContentView(R.layout.layout_homework02_3);
        textureView = (TextureView) findViewById(R.id.homework02_tv);
        //当textureView准备好之后，自动调用setSurfaceTextureListener的监听器
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            @Override
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
                //当textureView可用时，打开摄像头
                homework02_3.this.surfaceTexture = surfaceTexture;
